...
;;; 单击调用 Snipaste 截图；双击调用搜狗截图
;;;使用PrtSc按键调用搜狗输入法的截屏功能(需要先把搜狗输入法的截屏快捷键设置为ctrl+alt+s)
;;;使用PrtSc按键调用Snipaste的截屏功能(需要先把Snipaste的截屏快捷键设置为Win+F3)
PrintScreen::PressKeyManyTimes("press_1_prtsc_event","press_2_prtsc_event",400)
...
#IfWinActive ahk_exe Code.exe
    {
        ...
        ;;; 单击 F5 正常运行；双击 F5 保存。 
        F5::
            PressKeyManyTimes("press_1_f5_VSCode","press_2_f5_VSCode","press_2_f5_VSCode",500)		
        return
...
; ^v::
;     PressKeyManyTimes("press_1_cv_event","press_2_cv_event",400)
; return
;     press_1_cv_event(){
;         send,^v
;     }
